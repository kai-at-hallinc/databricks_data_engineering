...
user_defined_schema = StructType(
    [StructField('item_id', StringType(), True), StructField('name', StringType(), True), StructField('price', DoubleType(), True)]
)

products_df2 = spark.read.csv(
    products_csv_path,
    sep=",",
    header=True,
