...
-- MAGIC
-- MAGIC Please note that the material covered in this lab relates to workspaces that have Unity Catalog enabled, which is now a recommended best practice.
